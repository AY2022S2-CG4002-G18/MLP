...
################################################################
# This is a generated script based on design: mlp_block_design
#
...
# source mlp_block_design_script.tcl
...
set design_name mlp_block_design
...
proc create_root_design { parentCell } {
  ...
  # Create instance: myip_MLP_quant_HLS_0, and set properties
  set myip_MLP_quant_HLS_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:myip_MLP_quant_HLS:1.0 myip_MLP_quant_HLS_0 ]
  ...
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S] [get_bd_intf_pins myip_MLP_quant_HLS_0/S_AXIS]
  ...
  connect_bd_intf_net -intf_net myip_MLP_quant_HLS_0_M_AXIS [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM] [get_bd_intf_pins myip_MLP_quant_HLS_0/M_AXIS]
