...
model = keras.models.load_model('03300103')
...
## Layer 4
layer3_weights_object = model.trainable_variables[6]
layer3_weights_array = layer3_weights_object.numpy()
save_2d_weight_to_txt_file(layer3_weights_array, "./weights_files/layer4_weight.txt")
save_2d_weight_to_dat_file(layer3_weights_array, "./weights_files/layer4_weight.dat")
print("Saved Layer 4 weight")

layer3_bias_object = model.trainable_variables[7]
layer3_bias_array = layer3_bias_object.numpy()
save_1d_weight_to_txt_file(layer3_bias_array, "./weights_files/layer4_bias.txt")
save_1d_weight_to_dat_file(layer3_bias_array, "./weights_files/layer4_bias.dat")
