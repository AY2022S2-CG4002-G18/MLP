...
dc.append_to_datafile_from_single_source("data_0_1905.txt", 0, "data.csv", "label.csv")
...
dc.append_to_datafile_from_single_source("data_1_1907.txt", 1, "data.csv", "label.csv")
...
dc.append_to_datafile_from_single_source("data_2_1910.txt", 2, "data.csv", "label.csv")
...
dc.append_to_datafile_from_single_source("data_3_1912.txt", 3, "data.csv", "label.csv")
# dc.verify_datafile('data.csv')
# dc.verify_datafile('data_test.csv')

dc.train_test_split('data.csv', 'label.csv', 'data_train.csv', 'label_train.csv', 'data_test.csv', 'label_test.csv', 0.05)
# merge to test
